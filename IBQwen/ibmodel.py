...
class InformationBottleneck(nn.Module):
    ...
    def tokenchoose(self, image_embedding, hidden_states):
        ...
        k = int(image_embedding.size(1) / 2) # k的选择默认为image token数量的一半
        ...
        mask_ori = self.bottleneck.buffer_capacity # [bs, 50, 768]
        ...
        sc_indices = self.bottleneck.Spectral_Cluster_Voting(
        ...
        return image_embedding, iba_lamb, iba_alpha, loss_M