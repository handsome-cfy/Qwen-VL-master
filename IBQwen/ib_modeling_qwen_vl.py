...
from .ib_configuration_qwen_vl import IBQWenConfig
...
from .ibmodel import InformationBottleneck

logger = logging.get_logger(__name__)

_CHECKPOINT_FOR_DOC = "ibqwen"
_CONFIG_FOR_DOC = "IBQWenConfig"
...
class QWenPreTrainedModel(PreTrainedModel):
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, IBQWenModel):
            module.gradient_checkpointing = value


class IBQWenModel(QWenPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.ibmodel = InformationBottleneck(self.embed_dim, config.ib_beta)
...
class IBQWenLMHeadModel(QWenPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.transformer = IBQWenModel(config)
    ...
    def forward(
        ...
        # print("*********************This is IBQWenLMHeadModel*********************")
